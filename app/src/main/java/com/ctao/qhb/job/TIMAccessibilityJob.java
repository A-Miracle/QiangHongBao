 ...
 */
public class TIMAccessibilityJob extends BaseAccessibilityJob{

    private static final String TAG = "TIMAccessibilityJob";
    ...
    private static String ID_SUB_NAME = "com.tencent.tim:id/title_sub"; // 子标题(有子标题才是单聊)
    private static String ID_CALL_NAME = "com.tencent.tim:id/ivTitleBtnRightCall"; // 电话(有电话可能是单聊或讨论组)
    private static String ID_MSG_BOX = "com.tencent.tim:id/msgbox"; // msg box

    private static String ID_LIST_MSG_ITEM = "com.tencent.tim:id/relativeItem"; // 聊天记录列表中Item
    private static String ID_LIST_MSG_RED = "com.tencent.tim:id/unreadmsg"; // 聊天记录列表中Item小圆点
    private static String ID_LIST_MSG_LABEL = "com.tencent.tim:id/name"; // 聊天记录列表中Item最新消息(还好这里只有一个name的Id)
    private static String ID_LIST_MSG = "com.tencent.tim:id/recent_chat_list"; // 聊天记录列表

    private static String ID_LIST_CHAT = "com.tencent.tim:id/listView1"; // 当前会话列表
    private static String ID_LIST_CHAT_ITEM = "com.tencent.tim:id/chat_item_content_layout"; // ItemView, clickable=false; content-desc;

    private static String ID_LIST_CHAT_INPUT = "com.tencent.tim:id/input"; // EditText input
    private static String ID_LIST_CHAT_SEND = "com.tencent.tim:id/fun_btn"; // Button send
    private boolean isSilence;
    // TIM1.2.0 versionCode = 938;-----------------------------------

    @Override
    public String getPackageName() {
        return Config.PACKAGE_NAME_TIM;
    }

    @Override
    public boolean isEnable() {
        return config().isEnableTIM();
    }
    ...
    private boolean isRunningForeground(Context context){
        ...
        if(!tasks.isEmpty()){
            ...
            if(Config.PACKAGE_NAME_TIM.equals(packageName)){
                return true ;
            }
        }
        return false ;
